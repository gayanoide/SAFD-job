...
RegisterKeyMapping('Emysafd', 'Ouvrir le menu S.A.F.D', 'keyboard', 'F6')
...
RegisterCommand('Emysafd', function()
    ...
    options = {
        {
            ...
            onSelect = function()
				...
				TriggerServerEvent('hsafd:Ouvert')
        ...
        },
        {
            ...
            onSelect = function()
                ...
                TriggerServerEvent('hsafd:Fermer') 
...
RegisterNetEvent('safd:annonce')
AddEventHandler('safd:annonce', function()
	if ESX.PlayerData.job and ESX.PlayerData.job.name == 'safd' then
